...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "The Lab Perfumes — Independent Perfumery" },
      {
        name: "description",
        content:
          "Independent perfumery crafted between Colombia and Dubai. Explore The Lab Perfumes collection.",
      },
      { name: "author", content: "The Lab Perfumes" },
